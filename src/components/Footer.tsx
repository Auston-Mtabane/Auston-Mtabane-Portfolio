      ...
      <div className="footer-container">
        <div className="footer-content">
          ...
          <span className="footer-copyright">
            Auston Mtabane 2025, All rights reserved.
          </span>
        </div>
      </div>
    </footer>
